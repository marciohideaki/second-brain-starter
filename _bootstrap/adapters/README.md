...
=======
| **Codex CLI** | `AGENTS.md` | `~/.codex/skills/` | ❌ | ✅ | **functional** |
>>>>>>> Stashed changes
...
=======
2. **Exposes the skills** in whatever format the agent uses (slash commands, rules, global skills, or inline prompts).
>>>>>>> Stashed changes
